...
<tr>
     ...
     ?>
        ...
        <td class="action">
            ...
            <a href="../../../back/serveur_delete.php?id=<?php echo $row['id']; ?>" onclick="confirm('voullez vous vraiment supprimer l\'utilisateur')">
            ...
            <a href="../../../back/changerRole.php?id=<?php echo $row['id']; ?>">
